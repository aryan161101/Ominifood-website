...
$sql="INSERT INTO  tblusers(fname,email,password) VALUES(:fname,:email,:password)";
...
{?>
<span class="subheading" style="margin-bottom: 1rem; font-size: 1rem; font-weight: 200;">Welcome : <?php echo htmlentities($_SESSION['login']);?></span>
<span class="subheading" style="margin-bottom: 1rem; font-size: 1rem; font-weight: 200;"><a href="logout.php" >Logout</a></span>
<?php } ?>
        ...
        <div class="container">
          <div class="cta">
            <div class="cta-text-box">
              ...
              <form class="cta-form" name="sign-up" method="post" netlify>
                <div>
                ...
                <input type="submit" class="btn btn--form" name="submit" id="submit" value="CREATE ACCOUNT" />
                <input type="submit" class="login-right btn btn--form" name="submit" id="submit" value="LOGIN" />
                <!-- <input type="checkbox" />
                <input type="number" /> -->
              </form>
            </div>
